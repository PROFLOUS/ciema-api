...
class ApplicableCustomerRepository {
  ...
  async getApplicableCustomerByPromotionHeaderId(id) {
    const rs = await ApplicableCustomer.findAll({
      ...
      include: [
        {
          model: PromotionHeader,as:'promotionHeader'
        },
        {
          model: Rank,as:'rank'
        },
  ...
  async checkApplicablePromotionByTotalMoney({
    date,
    rank_id,
    totalMoney,
  }) {
              ...
              include: [
                {
                  ...
                  attributes: ["id", "IdProduct_buy", "qty_buy", "IdProduct_receive", "qty_receive", "total_purchase_amount", "money_received", "percent_reduction", "max_money_reduction",],
                },
              ],
              attributes: ["id", "promotionCode", "type", "max_qty","max_qty_per_customer_per_day","budget"],
            },
          ],
        },
      ],
